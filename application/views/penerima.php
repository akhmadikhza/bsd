    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-10 info-panel">
                <div class="row">
                    <div class="col-sm">
                        <img src="assets/landing/img/employee.png" alt="Employee" class="img-fluid float-left">
                        <h4>24 Hours</h4>
                        <p>Dapat diakses 24 jam realtime.</p>
                    </div>
                    <div class="col-lg">
                        <img src="assets/landing/img/uang.png" alt="HiRes" class="img-fluid float-left">
                        <h4>High-Res</h4>
                        <p>Memudahkan dalam pengelolaan bantuan desa.</p>
                    </div>
                    <div class="col-lg">
                        <img src="assets/landing/img/berkas.png" alt="Security" class="img-fluid float-left">
                        <h4>Transparation</h4>
                        <p>Transparansi pengelolaan data bantuan.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <section class="content mt-3">
            ...
            <div class="container-fluid">
                ...
                <div class="card-body">
                    ...
                    <p class="mt-3"><a href="#" class="text-white bg-success p-2 font-weight-bolder"><?= $title; ?></a></p>
