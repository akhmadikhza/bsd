<div class="row">
  <div class="col-lg-6">
    ...
    <div class="alert font-weight-bold" style="background-color:#07de92; color:white" role="alert">Selamat Datang, <?= $user['name']; ?> !</div>
    ...
    <div class="card mb-3">
      <div class="row no-gutters">
        ...
        <div class="col-lg-8 col-8">
          <div class="card-body">
            <h5 class="card-text text-success"><?= $user['nik']; ?></h5>
