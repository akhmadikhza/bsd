...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('assets/lte/plugins/bootstrap4-duallistbox/bootstrap-duallistbox.min.css'); ?>">
    <!-- BS Stepper -->
    <link rel="stylesheet" href="<?= base_url('assets/lte/plugins/bs-stepper/css/bs-stepper.min.css'); ?>">
    <!-- dropzonejs -->
    <link rel="stylesheet" href="<?= base_url('assets/lte/plugins/dropzone/min/dropzone.min.css'); ?>">
    <!-- Theme style -->
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group date" id="reservationdatetime" data-target-input="nearest">
                                        <input type="text" class="form-control datetimepicker-input" data-target="#reservationdatetime" data-toggle="datetimepicker" placeholder="DD/MM/YYYY" />
