...
<div class="row">
    ...
    <div class="col-md-4">
        <label>Upload Foto UMKM</label>
        <div class="custom-file">
            <input type="file" class="custom-file-input" id="umkm" name="umkm">
            <label class="custom-file-label" for="umkm">Choose file</label>
            <?= form_error('umkm', '<small class="text-danger">', '</small>'); ?>
        </div>
    </div>
