...
<!-- AdminLTE App -->
<script src="<?= base_url(); ?>assets/admin/dist2/js/adminlte.min.js"></script>
<!-- AdminLTE for demo purposes -->
<script src="<?= base_url(); ?>assets/admin/dist2/js/demo.js"></script>
<!-- <link rel="stylesheet" href="//cdnjs.cloudflare.com/ajax/libs/highlight.js/10.1.1/styles/default.min.css">
<script src="//cdnjs.cloudflare.com/ajax/libs/highlight.js/10.1.1/highlight.min.js"></script> -->

<!-- Select -->
<script src="<?= base_url(); ?>assets/admin/plugins2/select2/js/select2.full.min.js"></script>
<!-- date-range-picker -->
<script src="<?= base_url(); ?>assets/admin/plugins2/daterangepicker/daterangepicker.js"></script>
...
<!-- InputMask -->
<script src="<?= base_url(); ?>assets/admin/plugins2/moment/moment.min.js"></script>
<script src="<?= base_url(); ?>assets/admin/plugins2/inputmask/jquery.inputmask.min.js"></script>


<!-- Bootstrap4 Duallistbox -->
<script src="<?= base_url(); ?>assets/admin/plugins2/bootstrap4-duallistbox/jquery.bootstrap-duallistbox.min.js"></script>
